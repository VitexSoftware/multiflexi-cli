        ...
        switch ($action) {
            case 'list':
                ...
                if (!empty($fields)) {
                    ...
                    $apps = array_map(static function ($app) use ($fieldList) {
            ...
            case 'import-json':
                ...
                if ($format === 'json') {
                    ...
                    $output->writeln($result ? _('MultiFlexi Application imported successfully').': '.$result['name'] : 'Failed to import application');
                }
