...
{
    protected static $defaultName = 'credential:list';

    protected function configure(): void
    {
        $this
            ->setName('credential:list')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!empty($fields)) {
            ...
            $credentials = array_map(static fn ($c) => array_intersect_key($c, array_flip($fieldList)), $credentials);
        }
