...
use MultiFlexi\Cli\Command\EventRuleCommand;
use MultiFlexi\Cli\Command\EventSourceCommand;
...
$application->add(new EventSourceCommand());
$application->add(new EventRuleCommand());
